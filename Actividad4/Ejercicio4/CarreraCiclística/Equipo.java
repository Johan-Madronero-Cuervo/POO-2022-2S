...
public class Equipo {
    private String nombre; /*
                            * Atributo que define el nombre del equipo
                            * de ciclismo
                            */
    private static double totalTiempo; /*
                                        * Atributo que define el tiempo
                                        * total obtenido por el equipo
                                        */
    private String país; /*
                          * Atributo que define el país al que pertenece el
                          * equipo
                          */
    ...
    public Equipo(String nombre, String país) {
        ...
        listaCiclistas = new Vector(); /*
                                        * Se crea el vector de ciclistas que
                                        * conforma el equipo
                                        */
    }
